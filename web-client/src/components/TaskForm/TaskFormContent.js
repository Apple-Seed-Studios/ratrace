    ...
    <>
      <Grid container spacing={2}>
        <Grid item xs={10} sm={10} md={10} lg={10}>
          <TextField
            defaultValue={editTask ? editTask.task_name : ""}
            fullWidth
        ...
        <Grid item xs={10} sm={10} md={10} lg={10}>
          <TextField
            defaultValue={editTask ? editTask.task_description : ""}
            fullWidth
            multiline
            rows={4}
        ...
        {tagFormOpen ? (
          <>
            <Grid item xs={2} sm={2} md={2} lg={2}>
              ...
              ></TextField>
              <Button size="small" onClick={handleTags}>
                <CheckIcon />
              </Button>
              <Button size="small" onClick={() => setTagFormOpen(false)}>
                <HighlightOffIcon />
              </Button>
            </Grid>
          </>
